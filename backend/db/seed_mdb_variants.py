...
NEW_VARIANTS = [
    ...
    # per_kit = LBF rate, per_foot = SQF rate
    ("SM","Sheet Metal","SM-14", 'Sheet Metal Size 14',   2.44, 2.34, 10),
    ("SM","Sheet Metal","SM-15", 'Sheet Metal Size 15',   2.60, 2.50, 20),
    ("SM","Sheet Metal","SM-16", 'Sheet Metal Size 16',   2.77, 2.67, 30),
    ("SM","Sheet Metal","SM-17", 'Sheet Metal Size 17',   2.94, 2.83, 40),
    ("SM","Sheet Metal","SM-18", 'Sheet Metal Size 18',   3.11, 3.00, 50),
    ("SM","Sheet Metal","SM-19", 'Sheet Metal Size 19',   3.39, 3.17, 60),
    ("SM","Sheet Metal","SM-20", 'Sheet Metal Size 20',   3.57, 3.34, 70),
    ("SM","Sheet Metal","SM-21", 'Sheet Metal Size 21',   3.74, 3.50, 80),
    ("SM","Sheet Metal","SM-22", 'Sheet Metal Size 22',   3.90, 3.67, 90),
    ("SM","Sheet Metal","SM-23", 'Sheet Metal Size 23',   4.07, 3.83, 100),
    ("SM","Sheet Metal","SM-24", 'Sheet Metal Size 24',   4.23, 4.00, 110),
    ("SM","Sheet Metal","SM-25", 'Sheet Metal Size 25',   4.41, 4.17, 120),
    ("SM","Sheet Metal","SM-26", 'Sheet Metal Size 26',   4.57, 4.34, 130),
    ("SM","Sheet Metal","SM-27", 'Sheet Metal Size 27',   4.73, 4.50, 140),
    ("SM","Sheet Metal","SM-28", 'Sheet Metal Size 28',   4.90, 4.67, 150),
    ("SM","Sheet Metal","SM-29", 'Sheet Metal Size 29',   6.45, 4.83, 160),
    ("SM","Sheet Metal","SM-30", 'Sheet Metal Size 30',   6.67, 5.00, 170),
    ("SM","Sheet Metal","SM-31", 'Sheet Metal Size 31',   6.88, 5.17, 180),
    ("SM","Sheet Metal","SM-32", 'Sheet Metal Size 32',   7.10, 5.34, 190),
    ("SM","Sheet Metal","SM-33", 'Sheet Metal Size 33',   7.30, 5.50, 200),
    ("SM","Sheet Metal","SM-34", 'Sheet Metal Size 34',   7.52, 5.67, 210),
    ("SM","Sheet Metal","SM-35", 'Sheet Metal Size 35',   7.73, 5.83, 220),
    ("SM","Sheet Metal","SM-36", 'Sheet Metal Size 36',   7.94, 6.00, 230),
    ("SM","Sheet Metal","SM-37", 'Sheet Metal Size 37',   8.16, 6.17, 240),
    ("SM","Sheet Metal","SM-38", 'Sheet Metal Size 38',   8.37, 6.34, 250),
    ("SM","Sheet Metal","SM-39", 'Sheet Metal Size 39',   8.59, 6.50, 260),
    ("SM","Sheet Metal","SM-40", 'Sheet Metal Size 40',   8.80, 6.67, 270),
    ("SM","Sheet Metal","SM-41", 'Sheet Metal Size 41',   9.00, 6.83, 280),
    ("SM","Sheet Metal","SM-42", 'Sheet Metal Size 42',   9.22, 7.00, 290),
    ("SM","Sheet Metal","SM-43", 'Sheet Metal Size 43',   9.43, 7.17, 300),
    ("SM","Sheet Metal","SM-44", 'Sheet Metal Size 44',   9.64, 7.34, 310),
    ("SM","Sheet Metal","SM-45", 'Sheet Metal Size 45',   9.85, 7.50, 320),
    ("SM","Sheet Metal","SM-46", 'Sheet Metal Size 46',  10.07, 7.67, 330),
    ("SM","Sheet Metal","SM-47", 'Sheet Metal Size 47',  10.28, 7.83, 340),
    ("SM","Sheet Metal","SM-48", 'Sheet Metal Size 48',  10.49, 8.00, 350),
    ("SM","Sheet Metal","SM-49", 'Sheet Metal Size 49',  10.69, 8.17, 360),
    ("SM","Sheet Metal","SM-50", 'Sheet Metal Size 50',  14.70, 8.34, 370),
    ("SM","Sheet Metal","SM-51", 'Sheet Metal Size 51',  15.00, 0.17, 380),
